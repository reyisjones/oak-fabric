...
def process_image(source: Path, model: ModelClient, root: Path = ROOT) -> Path:
    ...
    observation = analyze_image(content, model)
    ...
    payload = {
        ...
        "image": asdict(info), "model": model.generation_model,
...
if __name__ == "__main__":
    ...
    print(process_image(args.source, client))
