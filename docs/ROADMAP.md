...
| 3.1 | In progress: code/synthetic smoke pass; real image pending | Preserve image and structured analysis | Real diagram, checksum unchanged, component/relationship accuracy and uncertainty review |
